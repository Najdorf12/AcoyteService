...
const Details = () => {
  return (
    <>
     ...
     <section id="brand-section" className="w-full h-screen flex flex-col z-50  text-balance">

      <p className="text-4xl font-title2 font-extrabold z-50 text-zinc-600 mt-12 pl-4">Alguien en <br />quien confiar. <span className="text-blue-500">Lorem Ipsum</span> </p>
      <figure className="w-[60%] flex  items-center z-50  mt-12 py-3 px-6 bg-white border-r-[3px]  border-b-[3px] border-blue-500 shadow-lg shadow-zinc-800  rounded-2xl">
        <img className="w-full object-cover rounded-2xl" src={imgGif} alt="" />
      </figure>
      <p className="text-2xl font-title2 font-extrabold z-50 text-zinc-300 mt-4 pl-4 w-[60%]">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Fugiat, reiciendis.</p>
     </section>
    </>
  );
};
