  ...
  return (
    <>
      <section className="z-50 w-full h-[100dvh] lg:h-screen relative">
        ...
        <article className="z-50 px-3 flex flex-col text-balance text-center justify-center items-center mt-7">
        ...
        <div className="w-full absolute bottom-6 flex justify-between text-balance">
          <div className="h-[120px] w-[45%] max-w-[350px] bg-gradient-to-tr from-zinc-800 via-blue-800 to-trasparent p-3 text-base font-title text-white rounded-r-2xl lg:h-[200px] lg:w-[25%]">
