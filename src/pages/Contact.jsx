const Contact = () => {
  return (
    <>
      <section id="contact-section" className="w-full h-screen md:h-auto flex flex-col bg-zinc-800 pb-8 rounded-2l xl:pb-20 2xl:h-screen lg:w-[60%] lg:self-center lg:rounded-r-3xl">
